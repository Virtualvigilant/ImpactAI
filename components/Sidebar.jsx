...
export function Sidebar({ onTopicSelect, onClear, messageCount }) {
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col bg-brand-dark border-r border-[var(--border)] h-full overflow-y-auto">
      ...
      <div className="px-4 py-3 border-b border-[var(--border)]">
        ...
        <div className="flex flex-col gap-1.5">
          {TOPICS.map(t => (
            <button
              key={t.label}
              onClick={() => onTopicSelect(`Tell me about ${t.label.toLowerCase()}`)}
